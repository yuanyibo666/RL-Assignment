    ...
    def genarate(self):
        ...
        for episode in range(self.episodes_num):
            ...
            for step in range(self.max_step):
                ...
                self.q_map[state][action] = self.q_map[state][action] + self.alpha*(reward + np.max(self.gamma * self.q_map[next_state,:]) - self.q_map[state][action])
...
if __name__ == "__main__":
    ...
    q_learning_instance = q_learning(env,observation_space_size,action_space_size,max_step,episodes_num,discount_rate,learn_rate,epsilon)
