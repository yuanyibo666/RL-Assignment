    ...
    def genarate(self):
        ...
        for episode in range(self.episodes_num):
            ...
            for step in range(self.max_step):
                ...
                next_state_expected = np.sum(self.q_map[next_state]*np.ones(action_space_size)/action_space_size)
                self.q_map[state][action] = self.q_map[state][action] + self.alpha*(reward + self.gamma * next_state_expected - self.q_map[state][action])
...
if __name__ == "__main__":
    ...
    q_learning_instance = expected_sarsa(env,observation_space_size,action_space_size,max_step,episodes_num,discount_rate,learn_rate,epsilon)
