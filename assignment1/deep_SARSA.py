...
class deepSarsa():  
    def __init__(self,env,state_dim,hidden_dim,action_dim,learning_rate,gamma,eplison,target_update,device):
        ...
        self.q_net = Network(state_dim,action_dim).to(device)      #qnet
        self.target_net = Network(state_dim,action_dim).to(device) #target net
...
if __name__ == "__main__":
    ...
    agent = deepSarsa(env,state_dim,hidden_dim,action_dim,lr,gamma,epsilon,target_update,device)
    return_list = []
